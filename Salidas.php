...
<div class="contenedor">
	...
	<div id="detalle">
		<table width='602' style='font-family:comic sans'>
			<tr bgcolor='#CBCBCB'>
				<td width='286' align='center' height='20'><input type='hidden' name='folio_sal' id='folio_sal' value='".$valor."'><strong>Descripcion</strong></td>
				<td width='55'><strong>Unidad</strong></td><td width='112' align='center'><strong>P.U.</strong></td>
				<td width='70'><strong>Cantidad</strong></td>
				<td width='133' align='center'><strong>Importe</strong></td>
				<td width='86'><strong>Entrega</strong></td>
			</tr>
		</table>
	</div>
