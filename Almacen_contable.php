...
$x=0;
$filas = array();
$sql = "SELECT * FROM Inventario where TIPO_INVENTARIO='contable'";
 //echo $sql;
       ...
       window.location.href = 'index.php' 
        ...
        $(document).ready(function () {          
			 ...
			 var source =
            {
                ...
                hierarchy:
                {
                    keyDataField: { name: 'Cat' },
                    parentDataField: { name: 'Descrip' }
                },
                id: 'Cat',
                localData: conceptos
            };
            ...
            $("#treeGrid").jqxTreeGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Almacen', dataField: 'ALMACEN', width: 112 },
                  { text: 'Articulo', dataField: 'ARTICULO', width: 120 },
                  { text: 'Descripcion', dataField: 'DESCRIPCION', width: 390 },
				  { text: 'UOM', dataField: 'UOM', width: 65 },
                  { text: 'PU', dataField: 'PU', width: 82 },
                  { text: 'Existencia', dataField: 'EXISTENCIA', width: 90 },
...
<div align="center">
<img src="images/contable.png" width="1049" border="0" />
<h1 style="font-family:fantasy;">Almac&eacute;n Contable </h1>
</div>
<br>
<br>
<center>
