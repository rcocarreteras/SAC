...
if ($_SESSION['S_Plaza'] == 'TODAS'){
	$_SESSION['S_Plaza'] = "LEON','OCOTLAN','PANINDICUARO','TEPATITLAN','TONALA','ZINAPECUARO','JALOSTOTITLAN";
}

$x=0;
$filas = array();
$sql = "select CvProy,CvTmo,CvBase,NoEmp,Empleado,Activo,CvPto,Tcosto,Plaza from catempleados WHERE PLAZA IN ('".$_SESSION['S_Plaza']."')";
 //echo $sql;
    ...
    <script type="text/javascript">
        $(document).ready(function () {          
            ...
            $("#treeGrid").jqxTreeGrid(
            {
                ...
                columns: [
                  { text: 'CvProy', dataField: 'CvProy', width: 70 },
                  { text: 'CvTmo', dataField: 'CvTmo', width: 60 },
                  { text: 'CvBase', dataField: 'CvBase', width: 70 },
                  { text: 'NoEmp', dataField: 'NoEmp', width: 70 },
                  { text: 'Nombre', dataField: 'Empleado', width: 350 },
                  { text: 'Activo', dataField: 'Activo', width: 70 },
				  { text: 'CvPto', dataField: 'CvPto', width: 70 },
                  { text: 'TCosto', dataField: 'Tcosto', width: 70 }
...
<?php } ?>
<div align="center">
<img border="0" src="images/catusu.png" />
<h1 style="font-family:fantasy;">Catálogo de Empleados</h1>
</div>
<br>
<br>
<center>
